...
=======
    ...
    const renderThumbnail = (file: File | string) => {
        ...
        return <div className="h-20 flex items-center justify-center text-3xl">📁</div>;
    };
    ...
    return (
        <>
            <div
                className={clsx(
                    "border-2 border-dashed border-gray-300 dark:border-white/20 rounded-md p-4 text-center cursor-pointer dark:bg-[#1A1B20]",
                    "transition-colors duration-300 h-full flex items-center justify-center flex-col",
                    "hover:bg-gray-100 dark:hover:bg-[#1A1B20]/10 focus-within:ring-2 focus-within:ring-blue-500/30",
                    className
                )}
                role="button"
                tabIndex={0}
            ...
            >
                ...
                {previewUrl && showPreview && (
                    <div
                        className="fixed inset-0 bg-black/60 flex justify-center items-center z-[999]"
                        onClick={(e) => { setPreviewUrl(null); e.stopPropagation() }}
                    >
                        <div
                            className="bg-white p-4 rounded-lg max-w-[90%] max-h-[90%] shadow-2xl text-center"
                            onClick={(e) => e.stopPropagation()}
